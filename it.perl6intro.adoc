...
[NOTE]
--
Rakudo Star contiene un editor di linea che permette di fare quasi tutto senza REPL.

Se hai installato il semplice Rakudo invece di Rakudo Star allora probabilmente non avrai
